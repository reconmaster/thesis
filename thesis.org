...
* Optimization-based algorithms
  - State "CANCELLED"  from ""           [2017-02-06 Mon 10:30] \\
    As I do not think there is sufficient time to do the typical parameter
    sweep approach we now use to address this framework, I am going to
    distribute this into the other chapters as way to illustrate some of
    the different optimization methods being used within the context of
    solving the problem I am setting out to address.
  :PROPERTIES:
  :ID:       06ec01f2-e128-4baf-9ec7-4569a3aaa886
  :ARCHIVE_TIME: 2017-02-06 Mon 10:34
  :ARCHIVE_FILE: ~/Seafile/medical_physics/thesis/thesis/thesis.org
...
the geometry of the scanning configuration is properly understood.
This is true regardless of whether the reconstruction is done with
...
The importance of accurate geometric has been extensively studied with
a variety of methods proposed for accurate geometric calibration
cite:rougee_geometrical_1993,mitschke_optimal_2000,silver_determination_2000,noo_analytic_2000,smekal_geometric_2004,cho_accurate_2005,yang_geometric_2006,panetta_optimization-based_2008,daly_geometric_2008,li_generic_2010,grimmer_empirical_2011,wicklein_image_2012.
Using the concepts discussed by
cite:rougee_geometrical_1993-1,silver_determination_2000, we developed
a calibration method that utilizes a phantom with known placement of
highly attenuating fiducials. By scanning this phantom and comparing
the the projections to the modeled forward-projection of a
