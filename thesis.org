...
\begin{figure}
  ...
  \caption{The left image shows the experimental setup of the acrylic
    ...
    circles. The remaining three are placed at different axial
    positions in one half of the image volume. The right image shows
    one of the low-contrast disks with the larger holes for the solid
    water RMI inserts.}
