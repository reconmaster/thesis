...
#+BEGIN_SRC asymptote :file figures/opt/weighting.pdf :exports results
settings.render = 0;
import geometry;
// size(8cm,0);
// unitsize(1cm)
...
#+BEGIN_SRC asymptote :file figures/geo/schematic.pdf :exports results
...
[[file:figures/geo/schematic.pdf]]
...
#+LABEL: fig:geo_coords
#+BEGIN_SRC asymptote :file figures/geo/coords.pdf :exports results
settings.multisample=0;
settings.outformat="pdf";
settings.prc = false;
settings.render = 0;
