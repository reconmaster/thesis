...
conclusions]]. We hypothesize that by implementing this
optimization-based non-circular scanning framework, we will be able to
maintain image quality while enabling scanning trajectories that are
potential solutions to real clinical limitations.
